            ...
            <div class="card">
                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        <form class="form" action="/c_pengeluaran/update/<?= $komik['id_transaksi']; ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('rincian_transaksi')) ? 'is-invalid' : ''; ?>" id="rincian_transaksi" name="rincian_transaksi" value="<?= $komik['rincian_transaksi']; ?>">
