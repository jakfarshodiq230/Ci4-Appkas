                                ...
                                <div class="card-block">
                                    <div class="media">
                                        <div class="media-body text-xs-left">
                                            <img src="/img/<?= $komik['foto']; ?>" alt="" class="img-thumbnail img-preview" width=74%; height="9.9%" style="margin-left:13% ;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="media-body text-xs-left">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control border-primary" type="email" value="<?= $komik['id_user']; ?>" disabled>
                                                </div>

                                                <div class="form-group">
                                                    <label for="userinput6">Rincian Transaksi</label>
                                                    <input class="form-control border-primary" type="url" value="<?= $komik['nama_pengguna']; ?>" disabled>
                                                </div>

                                                <div class="form-group">
                                                    <label for="userinput6">Jumlah</label>
                                                    <input class="form-control border-primary" type="url" value="<?= $komik['nama_provinsi']; ?>" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label for="userinput6">Harga</label>
                                                    <input class="form-control border-primary" type="url" value="<?= $komik['nama_kabupaten']; ?>" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label for="userinput6">Total</label>
                                                    <input class="form-control border-primary" type="url" value="<?= $komik['nama_kelurahan']; ?>" disabled>
                                                </div>
                                                <div class="form-group">
