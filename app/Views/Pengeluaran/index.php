                ...
                <div class="col-xs-12">
                    <div class="card border-success ">
                        <div class="card-header bg-success">
                            <h4 class="card-title" style="color:black;">Data Pengeluaran</h4>
                            ...
                            <div class="table-responsive card-block">
                                    ...
                                    <div class="col-xs-12 col-md-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="btn-group mb-0.1 ml-0.1 " style="float:lefth; margin-top:-15px;">
                                                <a href="/c_pengeluaran/create" class="btn btn-info btn-outline-primary mb-0.1 ">Tambah Data</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <table class="table table-bordered mb-0">
                                    <thead>
                                        <tr>
                                            <th scope="col">No</th>
                                            <th scope="col">Rincian Transaksi</th>
                                        ...
                                        <?php foreach ($orang as $k) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/c_pengeluaran/edit/<?= $k['id_transaksi']; ?>" class=" btn btn-warning">Edit</a>
                                                    <a href="/c_pengeluaran/<?= $k['id_transaksi']; ?>" class=" btn btn-primary">Lihat</a>
                                                    <!-- Modal -->
                                                        ...
                                                        <div class="modal-dialog modal-sm" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="/c_pengeluaran/delete/<?= $k['id_transaksi']; ?>" method="POST" class="d-inline">
                                                                        <?= csrf_field(); ?>
