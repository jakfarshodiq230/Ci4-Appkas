            ...
            <div class="card">
                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        <form class="form" action="/c_pemasukan/save" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="form-body">
                            ...
                            <div class="form-actions right">
                                <a href="/c_pemasukan" class="btn btn-warning"><i class="icon-cross2"></i> Cancel</a>
