                            ...
                            <div class="table-responsive card-block">
                                    ...
                                    <div class="col-xs-12 col-md-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="btn-group mb-0.1 ml-0.1 " style="float:lefth; margin-top:-15px;">
                                                <a href="/c_pengguna/create" class="btn btn-info btn-outline-primary mb-0.1 ">Tambah Data</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data_join->getResult() as $k) : ?>
                                            <tr>
                                                <td scope="row"><?= $no++; ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#del<?= $k->id_user ?>" class="btn btn-danger" data-toggle="modal">
                                                        Hapus
                                                    </a>
                                                    <a href="/c_pengguna/edit/<?= $k->id_user; ?>" class=" btn btn-warning">Edit</a>
                                                    <a href="/c_pengguna/<?= $k->id_user; ?>" class=" btn btn-primary">Lihat</a>
                                                    <!-- Modal -->
                                                    <div class="modal fade bd-example-modal-sm" id="del<?= $k->id_user; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body" style="text-align: center;">
                                                                    Apakah Anda ingin Menghapus Data <b><?= $k->id_user; ?></b>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <!-- <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> -->
                                                                    <form action="/c_pengguna/delete/<?= $k->id_user; ?>" method="POST" class="d-inline">
                                                                        <?= csrf_field(); ?>
